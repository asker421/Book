...
## Prompt readiness
- Глава 1: **FULL V3 PASS по rewrite/audit; ожидает решения пользователя** — текст `chapters_v3/01-16-avgusta.md`, prompt `prompts_v3/episodes/01.md`, log `worklogs_v3/01.md`.
