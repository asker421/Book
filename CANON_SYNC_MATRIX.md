...
> ## V4 ACTIVE MATRIX OVERRIDE — 20.09.2026
> Эта матрица ниже сохраняется как история V3 и не является release-gate для активной V4 по старым 35+5/31–35 строкам. Активная V4 имеет **30 глав + 4 интерлюдии**; финальный блок — `chapters_v4/29.md` и `chapters_v4/30.md`; его source of truth — `FINAL_CANON_OVERRIDE.md`, `V4_AUTHORING_RULES.md`, `V4_PROGRESS.md` и текущий художественный текст. Старые статусы `REWRITE REQUIRED` для бывших глав 31–35 не блокируют V4. Для финала V4 обязательны два независимых полных PASS по актуальным SHA 29–30.
